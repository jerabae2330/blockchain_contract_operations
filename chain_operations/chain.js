 ...
 */
const contract = {}
export async function init_chain_connection(){
...
export async function addAssests(document){
    await contract.submitTransaction('CreateAsset', document.id, document.student_id, document.admin_id,document.grade,document.subject,document.access_viewers);
}
